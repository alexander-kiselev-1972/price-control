...
class Command(BaseCommand):
    def set_to_base(self, NameWorkList, NameTable):
    ...
    def pars_xls(self, path):
        book_work = xlrd.open_workbook(path)

        return book_work

    def set_to_mnn_table(self, current_book):
    ...
    def set_to_lek(self, current_book):
    ...
    def control_dubles1(self, price, date_out, id_lek):
        duble_lek = 0
        try:
    ...
    def control_dubles2(self, price, date_in, id_lek):
        duble_lek = 0
        try:
    ...
    def set_to_history_price(self, file_object):
        # получаем количество листов в книге
